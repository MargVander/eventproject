...
RSpec.describe Event, type: :model do
  ...
  before(:each) do
    polette = User.new(first_name: "Paulette", last_name: "Jaquemin" , email:"paulette.jaquemin@yolo.com" ,description:"Hello c'est moi polette!")
    @event = Event.create(description: "yolo", location: "Mexico", title: "eventbrite" ,duration: 100 , price: 100 ,start_date: Time.new(2022, 10, 31) , admin: polette)
  ...
  context "validation" do
      ...
      describe "#price" do
        it "should be contained inside [0..1000] " do
          expect(@event.price <= 1000 && @event.price >= 0).to eq(true)
        end
      end
